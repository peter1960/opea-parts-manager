...
namespace OPEAManager
{
    class Tables
    {
        ...
        public void CreateSupplier() {
            ...
            Database.Instance.ExecuteNonQuery(sql);
            sql = "CREATE TABLE supplier (`SUPPLIER_ID` INTEGER PRIMARY KEY AUTOINCREMENT,`ACTIVE` TEXT, `ADDRESS1` TEXT ,`ADDRESS2` TEXT ,`NAME1` TEXT,`NAME2` TEXT,`PHONE1` TEXT, `PHONE2` TEXT,'CITY' TEXT,'STATE' TEXT, `URL` TEXT, `CONTACT` TEXT);";
            Database.Instance.ExecuteNonQuery(sql);

            stSupplier Record = new stSupplier();
            Record.Active = "Y";
            Record.Address1 = "27 Master Street";
            Record.Address2 = "Melbourne";
            Record.Name1 = "Kawasaki Australia";
        ...
        public void CreateFranchise() {
            ...
            Database.Instance.ExecuteNonQuery(sql);
            stFranchise Record = new stFranchise();
            Record.Active = "Y";
            Record.Custom = "N";
            Record.Prefix = "KAWA";
            Record.Supplier_id = 1;
            tbFranchise sp = new tbFranchise();
            sp.Update(Record);
